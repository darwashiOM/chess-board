...
class KioskTest(unittest.TestCase):
    def test_server_html_contains_five_button_navigation_hooks(self):
        ...
        self.assertIn("refreshWifiSetupNetworks", html)
        self.assertIn("passwordKeyboard", html)
        self.assertIn("appendPasswordChar", html)
        self.assertIn("selectWifiNetwork", html)
        self.assertIn("activeControlRoot", html)
        self.assertIn('document.body.dataset.stage === "wifi"', html)
        self.assertIn("focusFirstVisible", html)
